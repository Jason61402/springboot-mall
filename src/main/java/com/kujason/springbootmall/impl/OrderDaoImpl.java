...
import com.kujason.springbootmall.rowmapper.OrderItemRowMapper;
import com.kujason.springbootmall.rowmapper.OrderRowMapper;
    ...
    public void createOrderItems(Integer orderId, List<OrderItem> orderItemList) {
        String sql = "INSERT INTO order_item(order_id, product_id, quantity, amount)" +
                ...
                for (int i=0 ;i< orderItemList.size();i++) {
                    ...
                    parameterSources[i].addValue("quantity", orderItem.getQuantitiy());
